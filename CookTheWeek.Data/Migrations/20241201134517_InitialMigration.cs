        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Key identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false, comment: "Meal Plan Name")
                },
                constraints: table =>
                {
            ...
            type: "int",
            nullable: true,
            defaultValue: null); // Example default value
            ...
            //        StartDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()", comment: "Meal Plan Start Date"),
            ...
            //        DifficultyLevel = table.Column<int>(type: "int", nullable: true, comment: "Level of difficulty for the Recipe")
            //    },
            //    constraints: table =>
            //    {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    RecipeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Recipe Key Identifier"),
                    TagId = table.Column<int>(type: "int", nullable: false, comment: "Tag Key Identifier")
                },
                constraints: table =>
                {
