...
namespace CookTheWeek.Data.Migrations
{
    ...
    [Migration("20250106075216_UpdateRecipeIngredientUniqueIndexToIncludeNotes")]
    partial class UpdateRecipeIngredientUniqueIndexToIncludeNotes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CookTheWeek.Data.Models.RecipeIngredient", b =>
                {
                    ...
                    b.Property<string>("Note")
                        ...
                        .HasComment("User Notes for the given RecipeIngredient");
                    ...
                    b.HasIndex("RecipeId", "IngredientId", "MeasureId", "Note")
                        .IsUnique()
