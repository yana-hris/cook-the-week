...
//            //AllRecipesQueryModel expectedResult = new()
//            //{
//            //    TotalRecipes = data.Recipes.Where(r => r.Title == TestRecipe.Title).Count(),
...
//            // Act
//            var actualResult = await this.recipeService.AllAsync(testModel, TestUser.Id.ToString());

//            // Assert
//            //Assert.Multiple(() =>
//            //{
//            //    Assert.That(actualResult, Is.Not.Null);
//            //    Assert.That(actualResult, Is.InstanceOf<AllRecipesQueryModel>());

//            //    if (actualResult != null)
//            //    {
//            //        Assert.That(expectedResult.TotalRecipes, Is.EqualTo(actualResult.TotalRecipes));
